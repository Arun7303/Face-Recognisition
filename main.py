...
class face_recognition:
    def __init__(self, root):
        ...
        b3 = Button(self.root, image=self.photoimage3,
                    highlightbackground="black", highlightthickness=10,cursor="hand2",command=self.scan_face)
        ...
        b4 = Button(self.root, image=self.photoimage4,
                    highlightbackground="black", highlightthickness=10,cursor="hand2",command=self.exit_app)
    ...
    def scan_face(self):
        try:
            subprocess.Popen(["python", "scan_face.py"])
        except FileNotFoundError:
            print("Error: 'scan_face.py' not found.")
